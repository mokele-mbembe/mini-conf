...
const messages: Record<AppLocale, Record<string, string>> = {
  "zh-CN": {
    ...
    "deployments.filter.environmentPlaceholder": "环境，如 prod",
    ...
    "validation.deployments.environmentRequired": "请输入环境",
  ...
  "en-US": {
    ...
    "deployments.filter.environmentPlaceholder": "Environment, e.g. prod",
    ...
    "validation.deployments.environmentRequired": "Please enter an environment",
