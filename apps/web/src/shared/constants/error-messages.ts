...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  project_member_conflict: "error.project_member_conflict",
  project_member_not_found: "error.project_member_not_found",
  last_project_admin_required: "error.last_project_admin_required",
  project_code_conflict: "error.project_code_conflict",
  project_not_found: "error.project_not_found",
  project_delete_conflict: "error.project_delete_conflict",
  ...
  config_file_delete_conflict: "error.config_file_delete_conflict",
