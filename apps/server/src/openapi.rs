...
use schema::{
    ...
    auth::{AuthSessionResponse, AuthUser, ChangePasswordRequest},
...
#[openapi(
    ...
    paths(
        ...
        crate::http::api::auth::change_password,
        ...
        crate::http::api::admin_projects::delete_admin_project,
        ...
        crate::http::api::config_files::delete_config_file,
        ...
        crate::http::api::projects::delete_project,
